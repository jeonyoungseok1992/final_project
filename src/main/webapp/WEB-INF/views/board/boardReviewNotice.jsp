    ...
    <main class="contents board">
        ...
        <ul class="tr-pagination">
	        <c:choose>
	            ...
	            <c:otherwise>
	            	<li class="tr-page-prev"><a href="review.bo?cpage=${pi.currentPage -1 }">이전</a></li>
	            </c:otherwise>
	        </c:choose>
	        
	        <c:forEach var="p" begin="${pi.startPage }" end="${pi.endPage }">
	        	<li class="tr-current"><a href="review.bo?cpage=${p }">${p }<span class="sr-only"></span></a></li>
	        </c:forEach>
	        ...
	        <c:choose>
	            ...
	            <c:otherwise>
	            	<li class="tr-page-next"><a href="review.bo?cpage=${pi.currentPage +1 }">다음</a></li>
	            </c:otherwise>
	        </c:choose>    
        </ul>
    </main>
